...
public class DatabaseService : IDatabaseService
{
    ...
    [KernelFunction]
    [Description("Get all bookings for a single hotel.")]
        public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate([Description("The ID of the hotel")]int hotelId, [Description("The Date of the hotel booking")]DateTime dt)
    {
    ...
    [KernelFunction]
    [Description("Get Missing booking")]
...
[KernelFunction]
    [Description("Get all hotel bookings with multiple hotel rooms.")]
